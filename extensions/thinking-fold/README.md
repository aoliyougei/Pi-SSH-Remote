...
reasoning trace. Behavior is tunable in `/aoliyougei-settings` (fold depth, while/
...
![thinking-fold trace demo](https://raw.githubusercontent.com/aoliyougei/Pi-SSH-Remote/main/promo/demo/thinking-fold.gif)
...
![thinking-fold summary demo](https://raw.githubusercontent.com/aoliyougei/Pi-SSH-Remote/main/promo/demo/thinking-fold-summary.gif)
...
[`@aoliyougei/pi-cursor-effect`](../cursor-effect/README.md) to apply the
...
Run the shared `/aoliyougei-settings` menu. It lists installed `@aoliyougei`
